...
for line in lines:
	...
	if 'class="image-section"' in line or 'class="mw-file-element"' in line and 'src=' in line:
		'''
		...
		# uncomment the below to show the URL
		# print(image_URL)

		# This is printing what is called an f-string, this is not important however it is a very nice feature of python. Ask for an explanation
